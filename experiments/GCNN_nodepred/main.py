...
if __name__ == "__main__":
    PARAMS = {
        ...
        "eval_embeddings": False,  # set to True if you want to return embeddings
    }
    
    best_val_ce, test_acc, val_ce_history = run_experiment(PARAMS) # pred only returned if eval_embeddings=True

    data, _, _, _ = get_karateclub_data()  # Load the dataset to get the true labels
